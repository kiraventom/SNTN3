...
namespace SNTN3_Forms
{
    public partial class AddPicturesForm : Form
    {
        ...
        {
            MessageBox.Show(
                text: "Для добавления фотографий отдельно нажмите на кнопку с изображением фотоаппарата и знака плюса.\n" +
                "Для добавления папки с фотографиями нажмите на кнопку с изображением папки и знака плюса\n" +
                "Для удаления изображения из приложения нажмите на него левой кнопкой мыши.\n" +
                "Для возврата к авторизации нажмите на кнопку с изображением стрелки влево\n" +
                "Для перехода к редактированию нажмите на кнопку с изображением стреки вправо.",
                caption: "Справка",
